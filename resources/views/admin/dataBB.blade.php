    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tabel Berat Badan Balita</h3>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="/dataBB2" method="GET">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="/dataBB/edit/{{ $dtlk->id }}" class="btn btn-warning" ><i class="fa fa-edit"></i></a>
                                            <a href="/dataBB/hapus/{{ $dtlk->id }}" class="btn btn-danger" ><i class="fa fa-trash"></i></a>
                                          </td>
                                        </tr>
                                        @endforeach
                                    </thead>
